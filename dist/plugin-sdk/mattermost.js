...
const defaultImportPiSdk = () => import("./pi-model-discovery-BYc3OMMC.js");
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-BYc3OMMC.js");
			const agentDir = resolveOpenClawAgentDir();
