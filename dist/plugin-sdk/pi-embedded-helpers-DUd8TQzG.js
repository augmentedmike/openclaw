import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-BYfj5fuC.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-eFexkPEh.js";
import { Br as formatCliCommand, Er as secretRefKey, G as parseDurationMs, K as parseByteSize, Lr as resolveProcessScopedMap, On as containsEnvVarReference, Qr as resolveSecretInputRef, Rr as getProcessStartTime, W as getBlockedNetworkModeReason, bt as CHANNEL_IDS, ci as parseBooleanValue, i as loadConfig, l as writeConfigFile, qr as hasConfiguredSecretInput, t as createConfigIO, yr as resolveSecretRefValues, zr as isPidAlive } from "./config-BepKzj02.js";
import { C as normalizeE164, D as resolveUserPath, P as truncateUtf16Safe, a as createSubsystemLogger, l as defaultRuntime } from "./logger-BvBD-Tss.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-C87EQdYj.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-B0DVP62Z.js";
import { gt as normalizeChatType, r as normalizeChannelId } from "./plugins-BRropv2j.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Bl-XsUtT.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-MLD8DAip.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-MLD8DAip.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
