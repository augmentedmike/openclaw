...
import { t as sanitizeContentBlocksImages } from "./tool-images-BseS-MeV.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CvuXtje0.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CvuXtje0.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
