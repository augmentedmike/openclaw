...
import { dn as writeConfigFile, en as createConfigIO, rn as loadConfig } from "./model-selection-9r_l_jO9.js";
...
import { A as BrowserResourceExhaustedError, B as DEFAULT_AI_SNAPSHOT_MAX_CHARS, C as resolveCdpReachabilityTimeouts, D as BrowserProfileNotFoundError, E as BrowserConflictError, F as InvalidBrowserNavigationUrlError, H as DEFAULT_OPENCLAW_BROWSER_COLOR, I as assertBrowserNavigationAllowed, L as assertBrowserNavigationResultAllowed, M as BrowserTargetAmbiguousError, N as BrowserValidationError, O as BrowserProfileUnavailableError, P as toBrowserErrorResponse, R as withBrowserNavigationPolicy, T as BrowserConfigurationError, U as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as normalizeCdpHttpBaseForJsonEndpoints, a as resolveOpenClawUserDataDir, b as stopChromeExtensionRelayServer, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as BrowserTabNotFoundError, k as BrowserResetUnsupportedError, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, x as CDP_JSON_NEW_TIMEOUT_MS, y as ensureChromeExtensionRelayServer, z as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-Ctzy35UA.js";
import { i as isLoopbackHost } from "./ws-9b__y0UM.js";
import { a as resolveGatewayAuth } from "./auth-DSQKePpR.js";
import { n as hasGatewayPasswordEnvCandidate, o as readGatewayTokenEnv, r as hasGatewayTokenEnvCandidate } from "./credentials-BwEqaAZD.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-2pLi0rPx.js";
import { r as resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string-CJS9XNqN.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-Cv7mB3kX.js";
import { n as SsrFBlockedError } from "./proxy-env-CIMCkGtq.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-pZWEjkX3.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CzEcs72x.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-DqUvFkgx.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D4-z2J8p.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-D4-z2J8p.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
