...
import { H as loadConfig, X as writeConfigFile, z as createConfigIO } from "./auth-profiles-CNmVtedA.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-CQ90JO4F.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CdcrmTRQ.js";
import { A as BrowserResourceExhaustedError, B as DEFAULT_AI_SNAPSHOT_MAX_CHARS, C as resolveCdpReachabilityTimeouts, D as BrowserProfileNotFoundError, E as BrowserConflictError, F as InvalidBrowserNavigationUrlError, H as DEFAULT_OPENCLAW_BROWSER_COLOR, I as assertBrowserNavigationAllowed, L as assertBrowserNavigationResultAllowed, M as BrowserTargetAmbiguousError, N as BrowserValidationError, O as BrowserProfileUnavailableError, P as toBrowserErrorResponse, R as withBrowserNavigationPolicy, T as BrowserConfigurationError, U as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as normalizeCdpHttpBaseForJsonEndpoints, a as resolveOpenClawUserDataDir, b as stopChromeExtensionRelayServer, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as BrowserTabNotFoundError, k as BrowserResetUnsupportedError, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, x as CDP_JSON_NEW_TIMEOUT_MS, y as ensureChromeExtensionRelayServer, z as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-BS6eqJFC.js";
import { i as isLoopbackHost } from "./ws-31_ycKdn.js";
import { a as resolveGatewayAuth } from "./auth-B2vIWcNh.js";
import { n as hasGatewayPasswordEnvCandidate, o as readGatewayTokenEnv, r as hasGatewayTokenEnvCandidate } from "./credentials-CLFFYOLF.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-Cu8MtMRs.js";
import { r as resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string-DwB1jLZf.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-BLBkuJsj.js";
import { n as SsrFBlockedError } from "./proxy-env-CICc8epU.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BVPzyAHI.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-D1j3i0PL.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-LeEH8XsU.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-LeEH8XsU.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
