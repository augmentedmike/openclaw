...
import { t as sanitizeContentBlocksImages } from "./tool-images-CeL8wgEC.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CiSJQteK.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CiSJQteK.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
