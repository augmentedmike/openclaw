...
import { D as colorize, O as isRich$1, k as theme } from "./subsystem-BruFJSKI.js";
...
import { $n as runEmbeddedPiAgent, $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Lr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, pr as describeFailoverError, zt as maskApiKey } from "./compact-Bjrdj5JY.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BeE9L5Cn.js";
import { f as openUrl } from "./onboard-helpers-DmuPauTc.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Bzzb5XKX.js";
import { r as withProgressTotals } from "./progress-Cbwf1Zy5.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-C6UtT9sn.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-AylSKy01.js";
import { n as logConfigUpdated } from "./logging-C9NbEA_-.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-Bk_EqS20.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-CNmVtedA.js").then((n) => n.t);
	const { ensureOpenClawModelsJson } = await import("./models-config-DrRYMoob.js").then((n) => n.n);
