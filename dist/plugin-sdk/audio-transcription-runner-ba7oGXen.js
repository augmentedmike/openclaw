import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-DAoAqPuX.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./utils-C0UD7T2g.js";
import { B as resolveAgentModelFallbackValues, V as resolveAgentModelPrimaryValue, vt as runExec } from "./run-with-concurrency-C21l-3oD.js";
import { y as normalizeChatType } from "./plugins-DlF5uidn.js";
import { B as resolveIMessageAttachmentRoots, D as loadConfig, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, R as isInboundPathAllowed, Un as resolveOpenClawAgentDir, cr as normalizeGoogleModelId, i as resolveApiKeyForProvider, r as requireApiKey, tr as normalizeProviderId, z as mergeInboundPathRoots } from "./model-auth-gdEyA2v2.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DpvMOIrx.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-ONAWhtPS.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BgSFHAQa.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BQjJDtC6.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CeIMARXd.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-Brlqw0JN.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CSsk-Oah.js").then((n) => n.r);
