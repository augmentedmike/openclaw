import { et as consumeRootOptionToken } from "./subsystem-BruFJSKI.js";
...
import { $ as resolveAgentMainSessionKey, E as normalizeSessionDeliveryFields, P as readSessionTitleFieldsFromTranscript, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, c as loadSessionStore, ot as buildGroupDisplayName, tt as resolveMainSessionKey } from "./sessions-B4JU7_e2.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-C97U838V.js").then((n) => n.r);
