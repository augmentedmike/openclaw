import { p as restoreTerminalState } from "./subsystem-BruFJSKI.js";
...
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BKFTsQIT.js";
import { m as pathExists, v as resolveUserPath } from "./utils-BnJoR_rb.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-DmuPauTc.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BgXqLiZ7.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CUOFvOEU.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CUOFvOEU.js");
